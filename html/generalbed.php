<?php
include('generalbeds.php');
$sql = "SELECT * FROM gnrlbedinfo";
$result = $con->query($sql);
$sql1 = "SELECT * FROM gnrlbedreview";
...
<html>
    ...
    <meta name="author" content="Nikhil Chapadia">
        ...
        <link rel="stylesheet" href="generalbed.css">
    </head>
    <body>
        <div id="container">
            <ul>
...
<div id="head"> General Bed Booking</div>
