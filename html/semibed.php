<?php
include('semibeds.php');
$sql = "SELECT * FROM semibedinfo";
$result = $con->query($sql);
$sql1 = "SELECT * FROM semibedreview";
...
<html>
    ...
    <meta name="author" content="Nikhil Chapadia">
        ...
        <link rel="stylesheet" href="semibed.css">
    </head>
    <body>
        <div id="container">
            <ul>
...
<div id="head">Semi-Special Bed Booking</div>
